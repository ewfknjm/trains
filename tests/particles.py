...
class FireworkRule:
    def __init__(self, rule_type: int, min_age: float, max_age: float,  min_velocity: np.ndarray, max_velocity: np.ndarray, payloads: Payload, damping: float):
        self.type = rule_type
...
class FireworkSystem:
    ...
    def init_rules(self):
        self.rules[0] = FireworkRule(
            rule_type = 0, min_age = 0.5, max_age = 0.9,
        ...
        self.rules[1] = FireworkRule(
            rule_type = 1, min_age = 1.0, max_age = 1.5,
        ...
        self.rules[2] = FireworkRule(
            rule_type = 2, min_age = 0.5, max_age = 1.0,
    ...
    def spawn(self, firework_type: int, parent: Firework = None):
